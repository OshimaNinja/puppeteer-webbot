...
const getResult = async (data) => {
    ...
    await page.screenshot({ path: 'aboutyou.png' });
    await aboutYou2(page, value);
    await page.screenshot({ path: 'aboutyou2.png' });
    await aboutYou3(page, value);
    await page.screenshot({ path: 'aboutyou3.png' });
    ...
    await page.screenshot({ path: 'example112.png' });
...
aboutYou = async (page, value) => {
    ...
    // await page.waitForSelector('input[name="Customer_Email"]');
